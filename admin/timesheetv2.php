...
$("input[placeholder]").each(function () {
        ...
        function getlate() {
            ...
            document.getElementById('total_minute').innerHTML = "Remaining hours: "+resulttotal2+" hours";
...
<?php }else{ ?>
 ...
 <p>Remaining hours: <?php echo $showremaining; ?>  hours</p>
  <p id="total_minute"></p>
...
<tr></tr> -->
<tr class="daytotal">
<td style="width: 44px; height: 13px; text-align: center;"><?php echo date("D"); ?></td>
...
<?php if ($numcount==0) { ?>
<tr id="addedrow" style="visibility: hidden;">
<td>
...
<td>
    <textarea name='desc[]' rows='3' cols='80' required></textarea>
</td>
